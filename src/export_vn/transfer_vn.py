    ...
    with (
        ...
        if ctrl == "observations":
            ...
            CTRL_DEFS[ctrl](
                ...
                max_list_length=settings["TUNING"].get("max_list_length", 100),
                max_retry=settings["TUNING"].get("max_retry", 5),
                max_requests=settings["TUNING"].get("max_requests", 0),
                max_chunks=settings["TUNING"].get("max_chunks", 1000),
                unavailable_delay=settings["TUNING"].get("unavailable_delay", 600),
                retry_delay=settings["TUNING"].get("retry_delay", 5),
                pid_kp=settings["TUNING"].get("pid_kp", 0.0),
                pid_ki=settings["TUNING"].get("pid_ki", 0.003),
                pid_kd=settings["TUNING"].get("pid_kd", 0.0),
                pid_setpoint=settings["TUNING"].get("setpoint", 10000),
                pid_limit_min=settings["TUNING"].get("pid_limit_min", 5),
                pid_limit_max=settings["TUNING"].get("pid_limit_max", 2000),
