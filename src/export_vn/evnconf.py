...
class EvnCtrlConf:
    ...
    def __init__(self, ctrl: str, config: _ConfType) -> None:
        ...
        self._schedule_day_of_week = self._schedule_param(config["controler"][ctrl], "day_of_week")
        self._schedule_hour = self._schedule_param(config["controler"][ctrl], "hour")
        self._schedule_minute = self._schedule_param(config["controler"][ctrl], "minute")
        self._schedule_second = self._schedule_param(config["controler"][ctrl], "second")
    ...
    @property
    def schedule_year(self) -> str | int | None:
        """Return scheduling parameter."""
        return self._schedule_year

    @property
    def schedule_month(self) -> str | int | None:
        """Return scheduling parameter."""
        return self._schedule_month

    @property
    def schedule_day(self) -> str | int | None:
        """Return scheduling parameter."""
        return self._schedule_day

    @property
    def schedule_week(self) -> str | int | None:
        """Return scheduling parameter."""
        return self._schedule_week

    @property
    def schedule_day_of_week(self) -> str | int | None:
        """Return scheduling parameter."""
        return self._schedule_day_of_week

    @property
    def schedule_hour(self) -> str | int | None:
        """Return scheduling parameter."""
        return self._schedule_hour

    @property
    def schedule_minute(self) -> str | int | None:
        """Return scheduling parameter."""
        return self._schedule_minute

    @property
    def schedule_second(self) -> str | int | None:
        """Return scheduling parameter."""
